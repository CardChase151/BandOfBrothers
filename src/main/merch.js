...
import { ShoppingBag, Shield, Shirt, Award, Package } from 'lucide-react';
import BottomNav from '../bottomnav/bottomnav';

function Merch() {
  const [userProfile, setUserProfile] = useState(null);
  const [loading, setLoading] = useState(true);
  const [activeTab] = useState('licensing');
  ...
  const merchCategories = [
    { icon: Shirt, title: 'Apparel', description: 'T-shirts, hoodies, and tactical gear' },
    { icon: Award, title: 'Accessories', description: 'Patches, challenge coins, and more' },
    { icon: Package, title: 'Resources', description: 'Books, journals, and study materials' }
  ];
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
              <ShoppingBag size={40} color="#d97706" />
              <h1 style={{
                fontSize: '2rem',
                fontWeight: '900',
                color: '#f5f5f5',
          ...
          <div style={{
            ...
            <p style={{
              ...
              We're preparing gear and resources to equip you in the battle. Quality merchandise that reflects the warrior spirit.
            </p>
            <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Check back soon for updates on our store launch. Gear up for the battle ahead.
            </p>
          </div>
